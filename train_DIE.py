...
logger = TensorBoardLogger('logs', name='DIE')
...
class CoolSystem(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        train_set = Train_dataset(self.train_datasets, train=True, size=self.crop_size)
    ...
    def val_dataloader(self):
        ...
        val_set = Val_kdataset(self.validation_datasets, train=False)
